<template>
  <div class="club-container">
    <div class="club-container-box">
      <div class="b-div-1" style="margin-top: 35px;">
      ...
      <div class="club-button" style="margin-top:15px; margin-left: 350px;">
        <el-button @click.native.prevent="createForm" @click="open2()">提交</el-button>
      </div>
    </div>
